                      ...
                      FadeTransition(
                        opacity: Tween<double>(begin: 0.0, end: 1.0).animate(
                            CurvedAnimation(
                                parent: _widgetController,
                                curve:
                                    Interval(0.2, 1.0, curve: Curves.easeIn))),
                        child: SlideTransition(
                          position: _widgetTransition,
                          child: Column(
                            children: [
                      ...
                      FadeTransition(
                        opacity: Tween<double>(begin: 0.0, end: 1.0).animate(
                            CurvedAnimation(
                                parent: _widgetController,
                                curve:
                                    Interval(0.6, 1.0, curve: Curves.easeIn))),
                        child: SlideTransition(
                          position: _widgetTransition,
                          child: Align(
                            ...
                            child: GestureDetector(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Drop down forgot password",
                                      style:
                                          TextStyle(color: Color(0xff65BFB8)),
                                    ),
                                    SizedBox(
                                      width: 20,
                                    ),
